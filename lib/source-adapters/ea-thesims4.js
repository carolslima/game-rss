...
function extractArticles(html) {
  ...
  while ((match = articleRegex.exec(html)) !== null) {
    ...
    const linkedGame = groups.linkedTo
      ? groups.linkedTo.match(/"slug":"(the-sims-4|the-sims)"/)
      : null;
    ...
    // Remove o "The Sims Mobile" dos artigos (foco é The Sims 4)
 ...
 *
 * @param {object} config — source config (ea-thesims4.json)
